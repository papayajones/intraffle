...
//         uint seed;
//         uint totalTickets; // TODO: Can reduce this integer size
//     }

//     // TODO: Think about whether it should be this way or the other way around.
//     mapping(address => mapping(uint32 => uint)) private tickets; // TODO: Does this need to exist?
...
//         Raffle memory r = Raffle(cost, false, false, endBlockNumber, 0, 0);
//         id = raffleCounter;
